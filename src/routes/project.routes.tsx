...
export const projectRoutes: AppRoute[] = [
    ...
    // Projects
    {
        ...
        title: 'Projects',
        icon: Projector,
        element: withSuspense(() => import('@/modules/project/pages/projects/ProjectList')),
        nav: true,
    },
    {
        ...
        icon: Projector,
        element: withSuspense(() => import('@/modules/project/pages/projects/CreateProject')),
        nav: false,
    },
    {
        ...
        icon: Projector,
        element: withSuspense(() => import('@/modules/project/pages/projects/ProjectTemplates')),
        nav: false,
    },
    // Tasks
    {
        ...
        title: 'Tasks',
        icon: ListTodo,
        element: withSuspense(() => import('@/modules/project/pages/tasks/TaskList')),
        nav: true,
    },
    {
        ...
        title: 'My Tasks',
        icon: ListTodo,
        element: withSuspense(() => import('@/modules/project/pages/tasks/MyTasksPage')),
        nav: false,
    },
    {
        ...
        title: 'Task Board',
        icon: ListTodo,
        element: withSuspense(() => import('@/modules/project/pages/tasks/TaskBoardPage')),
        nav: false,
    },
    {
        ...
        title: 'Task Calendar',
        icon: Calendar,
        element: withSuspense(() => import('@/modules/project/pages/tasks/TaskCalendarPage')),
        nav: false,
    },
    // Team
    {
        ...
        title: 'Team Members',
        icon: Users,
        element: withSuspense(() => import('@/modules/project/pages/team/TeamMembersPage')),
        nav: true,
    },
    {
        ...
        icon: Users,
        element: withSuspense(() => import('@/modules/project/pages/team/RolesPage')),
        nav: false,
    },
    {
        ...
        title: 'Workload',
        icon: Users,
        element: withSuspense(() => import('@/modules/project/pages/team/WorkloadPage')),
        nav: false,
    },
    // Timeline & Milestones
    {
        ...
        title: 'Timeline',
        icon: Clock,
        element: withSuspense(() => import('@/modules/project/pages/timeline/TimelinePage')),
        nav: false,
    },
    {
        ...
        title: 'Milestones',
        icon: Calendar,
        element: withSuspense(() => import('@/modules/project/pages/milestones/MilestonesPage')),
        nav: false,
    },
    // Budget
    {
        ...
        title: 'Budget & Costs',
        icon: BarChart3,
        element: withSuspense(() => import('@/modules/project/pages/budget/BudgetPage')),
        nav: false,
    },
    // Risks
    {
        ...
        title: 'Risk Register',
        icon: AlertTriangle,
        element: withSuspense(() => import('@/modules/project/pages/risks/RiskRegisterPage')),
        nav: false,
    },
    // Reports
    {
        ...
        icon: FileText,
        element: withSuspense(() => import('@/modules/project/pages/reports/ProgressReportsPage')),
        nav: false,
    },
    {
        ...
        title: 'Time Reports',
        icon: FileText,
        element: withSuspense(() => import('@/modules/project/pages/reports/TimeReportsPage')),
        nav: false,
    },
    {
        ...
        icon: FileText,
        element: withSuspense(() => import('@/modules/project/pages/reports/FinancialReportsPage')),
        nav: false,
    },
];
