...
import ContactList from '@/modules/crm/components/contactManagement/contacts/ContactList';
import ContactFilters from '@/modules/crm/components/contactManagement/contacts/ContactFilters';
