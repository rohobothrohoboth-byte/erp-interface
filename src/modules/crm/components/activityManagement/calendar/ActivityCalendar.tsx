...
import { ChevronLeft, ChevronRight, Calendar, Clock, User, Phone, Mail, MessageSquare, FileText, Plus } from 'lucide-react';
...
export default function ActivityCalendar({ activities, onStatusChange, onEdit, onDelete }: ActivityCalendarProps) {
