...
import { updateQuote, getQuoteById } from '@/modules/crm/services/crm.api';
import { getCustomers, getOpportunities } from '@/modules/crm/services/crm.api';
import type { QuoteDto, QuoteLineDto } from '@/modules/crm/types/crm.types';
