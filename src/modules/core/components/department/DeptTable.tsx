...
import DeleteDeptModal from '@/modules/core/components/department/DeleteDeptModal';
import ViewDeptModal from '@/modules/core/components/department/ViewDeptModal';
import type { EditDeptDto, DeptListDto, UUID } from '@/modules/core/types/dept';
