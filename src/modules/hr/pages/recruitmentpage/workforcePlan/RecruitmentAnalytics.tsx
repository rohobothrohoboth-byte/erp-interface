// src/pages/hr/recruitment/RecruitmentAnalytics.tsx
                            ...
                            <CardContent className="p-4">
                                ...
                                <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm text-gray-500">Chart component will be added</p>
            ...
            {activeTab === 'applicants' && (
                <Card>
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-gray-500">Applicants analytics will be displayed here</p>
                        <p className="text-sm text-gray-400">Detailed metrics about applicants</p>
                    </CardContent>
                </Card>
            )}
            ...
            {activeTab === 'postings' && (
                <Card>
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-gray-500">Postings analytics will be displayed here</p>
                        <p className="text-sm text-gray-400">Detailed metrics about job postings</p>
                    </CardContent>
                </Card>
            )}
            ...
            {activeTab === 'plans' && (
                <Card>
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-gray-500">Workforce plans analytics will be displayed here</p>
                        <p className="text-sm text-gray-400">Detailed metrics about workforce plans</p>
                    </CardContent>
                </Card>
            )}
        </motion.div>
