...
import { useReviewJobRequisition } from '@/modules/hr/services/recruitment/jobRequisition/jobRequisition.queries';
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }}
            ...
            <div className="flex items-center gap-3 border-b px-6 py-4">
              ...
              <div className="flex-1">
                <h2 className="text-lg font-bold text-gray-800">Review Job Requisition</h2>
                <p className="text-xs text-gray-500">{item.reqNumber}</p>
              </div>
...
export default JobRequisitionReviewModal;
