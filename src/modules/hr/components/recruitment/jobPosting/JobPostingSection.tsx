...
import JobPostingSearchFilter from '@/modules/hr/components/recruitment/jobPosting/JobPostingSearchFilter';
import JobPostingTable from '@/modules/hr/components/recruitment/jobPosting/JobPostingTable';
import EditJobPostingModal from '@/modules/hr/components/recruitment/jobPosting/EditJobPostingModal';
import DeleteJobPostingModal from '@/modules/hr/components/recruitment/jobPosting/DeleteJobPostingModal';
import PublishJobPostingModal from '@/modules/hr/components/recruitment/jobPosting/PublishJobPostingModal';
import JpEvalFlowModal from '@/modules/hr/components/recruitment/jobPosting/JpEvalFlowModal';
import {
  useJobPostings,
  useJobPostingsByWfp,
  useUpdateJobPosting,
...
import { useJobRequisition } from '@/modules/hr/services/recruitment/jobRequisition/jobRequisition.queries';
import type { JobPostingListDto, JobPostingModDto } from '@/modules/hr/types/recruit/jobPosting';
import { useCloseJobPosting, usePublishAllJobPosting, usePublishJobPosting } from '@/modules/hr/services/recruitment/JobPublish/jobPublish.queries';
