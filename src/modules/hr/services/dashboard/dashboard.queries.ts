...
import {
  ...
  getPendEmpEduExp,
  dashboardApi
} from '@/modules/hr/services/dashboard/dashboard.api';
import type {
  EmpDbPendList,
  EmpDbReport,
  EmpExpEduPendList
} from '@/modules/hr/types/dashboard';
import type { HrDashboardResponse, ActivityItem, EventItem } from '@/modules/hr/types/dashboard.types';
