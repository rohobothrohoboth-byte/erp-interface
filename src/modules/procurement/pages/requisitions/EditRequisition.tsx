...
import { getRequisitionById, updateRequisition } from '@/modules/procurement/services/requisition.api';
import { uploadFile, deleteFile, getFilesByReference, downloadFile } from '@/modules/file/services/fileManagement/fileManagementApi';
