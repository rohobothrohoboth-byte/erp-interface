...
import { ClipboardList, Upload, X, File, Image, FileText, Loader2 } from "lucide-react";
import { Label } from "@/shared/components/ui/label";
import { Input } from "@/shared/components/ui/input";
import { EducationLevel } from "@/shared/types/enum";
...
import type { EmpEduAddDto } from "@/modules/profile/types/EmpEdu.types";

interface AddEducationModalProps {
  isOpen: boolean;
  isLoading?: boolean;
  onClose: () => void;
  onSubmit: (data: EmpEduAddDto) => void;
}
...
const AddEducationModal: React.FC<AddEducationModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // ✅ Create a clean DTO object
    const submitData: EmpEduAddDto = {
    ...
    // ✅ Only add certificateFileId if it exists
    if (form.certificateFileId) {
      submitData.certificateFileId = form.certificateFileId;
    }
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-3 border-b px-6 py-4 sticky top-0 bg-white z-10">
                  ...
                  <h2 className="text-lg font-bold text-gray-800">Add Education</h2>
                </div>
                      ...
                      {uploadError && (
                          <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                            ...
                            <p className="text-xs text-red-400 mt-1">
                              You can still save the education record without a certificate and upload it later.
                            </p>
                          </div>
                      )}
