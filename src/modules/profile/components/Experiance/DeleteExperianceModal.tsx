...
interface DeleteExperianceModalProps {
  EmpExp: EmpExpListDto | null;
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (empExpId: string) => void;
}

const DeleteExperianceModal: React.FC<DeleteExperianceModalProps> = ({
  EmpExp,
  isOpen,
  onClose,
  onConfirm,
}) => {
  if (!isOpen || !EmpExp) return null;
...
export default DeleteExperianceModal;
