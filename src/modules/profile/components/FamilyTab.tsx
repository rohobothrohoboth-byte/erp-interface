...
import { Relation, Gender } from "@/shared/types/enum";
import { Button } from "@/shared/components/ui/button";
import { showToast } from "@/shared/layout/layout";
import type { ProFamilyList } from "@/modules/profile/types/profile.types";
...
export function FamilyTab() {
  ...
  return (
      ...
      "
          ...
          {addingNew && (
              <div className="m-4 p-4 rounded-xl border border-green-200 bg-white">
          ...
          <div className="space-y-2 p-6">
            {members.map((m) => {
              ...
              return (
                  <div
                      key={m.id}
                      className={`rounded-xl border transition-all ${isOpen ? "border-green-200 shadow-sm" : "border-gray-100"}`}
                  >
