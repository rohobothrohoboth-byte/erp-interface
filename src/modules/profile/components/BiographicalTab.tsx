...
import type {
  BiographicalForm,
  FinancialForm,
} from "@/modules/profile/stores/profile.store";
import { InlineEditCard } from "@/modules/profile/components/InlineEditCard";
import { EditableField } from "@/modules/profile/components/EditableField";
import { Field, Grid } from "@/modules/profile/components/shared";
...
import { YesNo } from "@/shared/types/enum";
import SelectEnum from "@/shared/components/ui/selectEnum";
...
export const BiographicalTab = memo(function BiographicalTab() {
  ...
  useEffect(() => {
    if (bio) {
      setBioForm({
        ...
        hasBirthCert: bio.hasBirthCert,
        hasMarriageCert: bio.hasMarriageCert,
      });
      setFinForm({
        tin: bio.tin,
  ...
  }, [bio?.id, bioForm, saveBiographical, invalidateProfile]);
  ...
  }, [bio?.id, finForm, saveFinancial, invalidateProfile]);
  ...
  return (
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <InlineEditCard
            ...
            actionOverride={
              !bioEditing ? <ActionBtn onEdit={openBioEdit} /> : undefined
            }
        >
        ...
        <InlineEditCard
            ...
            actionOverride={
              !finEditing ? <ActionBtn onEdit={openFinEdit} /> : undefined
            }
        >
          <Grid>
            <EditableField
