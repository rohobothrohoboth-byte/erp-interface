...
import { DEFAULT_FORM_DATA, ITEMS_PER_PAGE } from '@/modules/finance/constants/journalEntryConstants';
import { getBranches, getEmployees, getDepartments } from '@/modules/finance/services/finance.api'; // ✅ ADD getDepartments
...
import type {
    ...
    JournalEntryFilters,
    JournalLine
} from '@/modules/finance/types/journalEntry.types';
