// src/pages/finance/ar/components/InvoiceExportModal.tsx
...
import type { InvoiceStats } from '@/modules/finance/pages/ar/types/invoice.types';
            ...
            <DialogContent className="max-w-sm">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        Export Invoice Posting Report
                    </DialogTitle>
                    <DialogDescription>
                        Export the invoice posting report in your preferred format.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div>
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                            ...
                            <p>Status: <strong>{statusFilter === 'all' ? 'All' : statusFilter}</strong></p>
