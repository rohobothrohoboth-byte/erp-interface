...
import { Zap, PlusCircle, CreditCard, Download, Repeat, Building, BarChart3 } from 'lucide-react';
...
export const TransactionsQuickActions: React.FC<TransactionsQuickActionsProps> = ({
  onAddTransaction,
  onImportStatement,
  onReconcileAccounts,
  onTransferFunds,
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-indigo-200">
      <h2 className="text-xl font-bold mb-4 flex items-center space-x-2 text-indigo-900">
        ...
        <span>Transactions Quick Actions</span>
      </h2>
