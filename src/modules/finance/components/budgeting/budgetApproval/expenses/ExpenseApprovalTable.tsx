...
import { Check, X, RotateCcw, MoreVertical, Eye, Receipt, ChevronLeft, ChevronRight } from 'lucide-react';
...
import RejectExpenseModal from '@/modules/finance/components/budgeting/budgetApproval/expenses/RejectExpenseModal';
import ReturnExpenseModal from '@/modules/finance/components/budgeting/budgetApproval/expenses/ReturnExpenseModal';
...
interface ExpenseApprovalTableProps {
  ...
  onViewDetails: (expense: BudgetExpenseWithApproval) => void;
}
                          ...
                          <PopoverContent className="w-48 p-0" align="end">
                            <div className="py-1">
                              ...
                              <button
                                ...
                                className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 rounded text-green-600 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                              >
                                <Check size={16} />
                                Approve
                              </button>
                              ...
                              <button
                                ...
                                disabled={!canTakeAction}
                                className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 rounded text-red-600 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                              >
                                <X size={16} />
                                Reject
                              </button>
                              ...
                              <button
                                ...
                                disabled={!canTakeAction}
                                className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 rounded text-blue-600 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                              >
                                <RotateCcw size={16} />
                                Return
                              </button>
