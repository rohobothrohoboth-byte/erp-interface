...
import { MoreVertical, PenBox, Trash2, FileText, Settings, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            {paginatedPlans.length === 0 ? (
              ...
              paginatedPlans.map((plan, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-1 whitespace-nowrap text-sm text-gray-900 hidden sm:table-cell">
                    <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusColor(plan.status)}`}>
                      {plan.status}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-1 whitespace-nowrap text-right text-sm font-medium">
                    <Popover open={popoverOpen === plan.id} onOpenChange={(open) => setPopoverOpen(open ? plan.id : null)}>
