...
interface DeleteBudgetPlanModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  planName: string;
...
export default function DeleteBudgetPlanModal({
  isOpen,
  onClose,
  onConfirm,
  planName
}: DeleteBudgetPlanModalProps) {
      ...
      >
        <div className="p-6">
          <div className="py-4 text-center">
            ...
            <p className="text-sm text-gray-600 mt-2 font-semibold">"{planName}"</p>
