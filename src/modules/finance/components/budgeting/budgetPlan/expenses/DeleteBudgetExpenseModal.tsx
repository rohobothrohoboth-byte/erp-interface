...
interface DeleteBudgetExpenseModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
export default function DeleteBudgetExpenseModal({
  isOpen,
  onClose,
  onConfirm,
  expenseAccount
}: DeleteBudgetExpenseModalProps) {
      ...
      >
        <div className="p-6">
          <div className="py-4 text-center">
            ...
            <p className="text-sm text-gray-600 mt-2 font-semibold">"{expenseAccount}"</p>
