...
interface DeleteAdditionalBudgetModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  requestName: string;
...
export default function DeleteAdditionalBudgetModal({
  isOpen,
  onClose,
  onConfirm,
  requestName
}: DeleteAdditionalBudgetModalProps) {
      ...
      >
        <div className="flex justify-between items-center border-b dark:border-gray-700 px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-gray-800 dark:text-white">Delete Additional Budget Request</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-4">
          <p className="text-gray-600 dark:text-gray-300">
            Are you sure you want to delete the additional budget request for{' '}
