...
import PaymentEntryTable from '@/modules/finance/components/accountsPayable/PaymentEntryTable';
...
import type { PaymentEntry, Invoice } from '@/modules/finance/components/accountsPayable/types';
