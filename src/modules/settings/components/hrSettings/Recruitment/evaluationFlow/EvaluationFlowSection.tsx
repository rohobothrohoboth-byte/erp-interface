...
import EvaluationFlowHeader from '@/modules/settings/components/hrSettings/Recruitment/evaluationFlow/EvaluationFlowHeader';
import EvaluationFlowSearchFilter from '@/modules/settings/components/hrSettings/Recruitment/evaluationFlow/EvaluationFlowSearchFilter';
import EvaluationFlowTable from '@/modules/settings/components/hrSettings/Recruitment/evaluationFlow/EvaluationFlowTable';
import AddEvaluationFlowModal from '@/modules/settings/components/hrSettings/Recruitment/evaluationFlow/AddEvaluationFlowModal';
import EditEvaluationFlowModal from '@/modules/settings/components/hrSettings/Recruitment/evaluationFlow/EditEvaluationFlowModal';
import DeleteEvaluationFlowModal from '@/modules/settings/components/hrSettings/Recruitment/evaluationFlow/DeleteEvaluationFlowModal';
import {
  useEvaluationFlows,
...
} from '@/modules/hr/services/recruitment/evaluationFlow/evaluationFlow.queries';
