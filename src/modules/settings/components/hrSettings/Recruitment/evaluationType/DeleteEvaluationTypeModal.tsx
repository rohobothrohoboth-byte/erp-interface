...
interface DeleteEvaluationTypeModalProps {
  isOpen: boolean;
  name: string;
  isLoading?: boolean;
  onClose: () => void;
...
const DeleteEvaluationTypeModal: React.FC<DeleteEvaluationTypeModalProps> = ({ isOpen, name, isLoading = false, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-6">
      ...
      >
        <div className="p-6 text-center">
          ...
          <p className="text-lg font-medium text-gray-900 mb-1">Delete Evaluation Type</p>
...
export default DeleteEvaluationTypeModal;
