...
interface DeleteEducationalQualModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (educationalQual: EducationQualListDto) => void;
}

const DeleteEducationalQualModal: React.FC<DeleteEducationalQualModalProps> = ({
  educationalQual,
  isOpen,
  onClose,
  onConfirm,
}) => {
  if (!isOpen || !educationalQual) return null;

  const handleConfirm = () => {
    onConfirm(educationalQual);
  };
        ...
        <div className="p-6">
          <div className="py-4 text-center">
            ...
            <p className="text-lg font-medium text-red-600 mt-4">
              Are you sure you want to delete this educational qualification?
            </p>
...
export default DeleteEducationalQualModal;