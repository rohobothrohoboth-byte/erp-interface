...
import type { PolicyAssignmentRuleListDto, UUID } from "@/modules/core/types/Settings/policyAssignmentRule";

interface DeletePolicyAssignmentRuleModalProps {
...
const DeletePolicyAssignmentRuleModal: React.FC<
  DeletePolicyAssignmentRuleModalProps
...
export default DeletePolicyAssignmentRuleModal;
