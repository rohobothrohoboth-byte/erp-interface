...
import AccountDetailHeader from '@/modules/settings/components/FinanceSettings/chartofAccount/accountDetail/AccountDetailHeader';
import AccountInfoCard from '@/modules/settings/components/FinanceSettings/chartofAccount/accountDetail/AccountInfoCard';
import AccountTransactionsTable from '@/modules/settings/components/FinanceSettings/chartofAccount/accountDetail/AccountTransactionsTable';
