...
interface DeleteBudgetCodeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const DeleteBudgetCodeModal: React.FC<DeleteBudgetCodeModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  budgetCodeName,
      ...
      >
        ...
        <div className="p-6">
          <div className="py-4 text-center">
            ...
            <p className="text-sm text-gray-600 mt-2 font-semibold">"{budgetCodeName}"</p>
...
export default DeleteBudgetCodeModal;
