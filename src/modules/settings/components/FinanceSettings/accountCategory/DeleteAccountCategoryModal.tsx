...
interface DeleteAccountCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  categoryName: string;
...
const DeleteAccountCategoryModal: React.FC<DeleteAccountCategoryModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  categoryName,
...
export default DeleteAccountCategoryModal;
