...
import type { CostCenter } from '@/modules/settings/components/FinanceSettings/costCenter/CostCenterSection';
...
const AddCostCenterModal: React.FC<AddCostCenterModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submitData: Omit<CostCenter, 'id' | 'createdAt' | 'children'> = {
      ...formData,
      parentCode: parentCostCenter?.costCenterCode,
    };
      ...
      >
        ...
        <div className="flex justify-between items-center border-b px-6 py-4 sticky top-0 bg-white z-10">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-gray-800">
              {isFirstCostCenter 
                ? 'Add Root Cost Center' 
                : parentCostCenter 
                  ? `Add Child to ${parentCostCenter.name}` 
                  : 'Add Cost Center'}
            </h2>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-6 py-4 space-y-4">
            ...
            {/* Is Group - Hidden for first cost center since it's always a group */}
            {!isFirstCostCenter && (
              <div className="flex items-center gap-2">
                <input
                  type="checkbox"
