...
import { Mail, MoreVertical, Edit, Trash2, ChevronLeft, ChevronRight } from "lucide-react";
...
const EmailTemplatesTable: React.FC<EmailTemplatesTableProps> = ({ templates, onEdit, onDelete, onToggleActive }) => {
            ...
            {paginated.length === 0 && (
              <tr>
                <td colSpan={5} className="p-4 text-center">
                  <Mail className="w-5 h-5 mx-auto mb-2 text-gray-300" />
                  <p className="text-sm font-medium text-gray-500 mb-1">No Email Templates Found</p>
                </td>
              </tr>
            )}
            {paginated.map((template, index) => (
              ...
              >
                ...
                <td className="px-4 py-2 max-w-xs">
                  <span className="text-sm text-gray-600 truncate block">{template.subject}</span>
                </td>
                <td className="px-4 py-2 whitespace-nowrap">
