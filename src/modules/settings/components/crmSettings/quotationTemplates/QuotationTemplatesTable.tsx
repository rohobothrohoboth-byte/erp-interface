...
import { FileText, MoreVertical, Edit, Trash2, ChevronLeft, ChevronRight } from "lucide-react";
import { Popover, PopoverTrigger, PopoverContent } from "@/shared/components/ui/popover";
import type { QuotationTemplate } from "@/modules/settings/components/crmSettings/quotationTemplates/QuotationTemplatesSection";
...
const QuotationTemplatesTable: React.FC<QuotationTemplatesTableProps> = ({ templates, onEdit, onDelete, onToggleActive }) => {
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-white">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Quotation Title</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Validity (Days)</th>
            ...
            {paginated.map((template, index) => (
              ...
              >
                ...
                <td className="px-4 py-2 max-w-xs">
                  <span className="text-sm text-gray-600 truncate block">{template.title}</span>
                </td>
                <td className="px-4 py-2 whitespace-nowrap">
