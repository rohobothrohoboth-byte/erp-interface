...
const DATA: Row[] = [{ id: "t1", projectCode: "PRJ-2401", title: "Approve interior package", status: "In Progress", priority: "High", dueDate: "2026-08-15" }, { id: "t5", projectCode: "PRJ-2401", title: "MEP coordination meeting", status: "Blocked", priority: "High", dueDate: "2026-08-12" }, { id: "t6", projectCode: "PRJ-2407", title: "Review migration checklist", status: "Backlog", priority: "Medium", dueDate: "2026-08-22" }];
...
export default function MyTasksPage() {
  ...
  return (
    <ModulePageShell
      title="My Tasks"
      subtitle="Tasks assigned to the current user."
      stats={stats}
      searchValue={search}
      onSearchChange={setSearch}
      searchPlaceholder="Search..."
      onRefresh={() => showToast.success("Refreshed My Tasks")}
