// src/pages/file/FolderContentsPage/components/FileList.tsx

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { Download, Move, Share2, Trash2, Star, Loader2 } from 'lucide-react';
import { Badge } from '@/shared/components/ui/badge';
import { formatDistanceToNow } from 'date-fns';
import { getFileIcon, getFolderIcon, formatFileSize } from '@/modules/file/pages/FolderContentsPage/utils/helpers';
import { toggleFavorite } from '@/modules/file/services/fileManagement/fileManagementApi';
...
export const FileList: React.FC<FileListProps> = ({
    ...
    const handleFavoriteClick = async (e: React.MouseEvent, item: any) => {
        ...
        if (!docId) {
            console.error('❌ [FileList] No ID found in item:', item);
