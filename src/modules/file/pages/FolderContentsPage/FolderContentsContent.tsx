...
// Components
import { Header } from '@/modules/file/pages/FolderContentsPage/components/Header';
import { Stats } from '@/modules/file/pages/FolderContentsPage/components/Stats';
import { CategoryFilter } from '@/modules/file/pages/FolderContentsPage/components/CategoryFilter'; // ✅ Import CategoryFilter
import { Toolbar } from '@/modules/file/pages/FolderContentsPage/components/Toolbar';
import { FileGrid } from '@/modules/file/pages/FolderContentsPage/components/FileGrid';
import { FileList } from '@/modules/file/pages/FolderContentsPage/components/FileList';
import { EmptyState } from '@/modules/file/pages/FolderContentsPage/components/EmptyState';
import { UploadModal } from '@/modules/file/pages/FolderContentsPage/components/UploadModal';
import { SubfolderModal } from '@/modules/file/pages/FolderContentsPage/components/SubfolderModal';
import { MoveModal } from '@/modules/file/pages/FolderContentsPage/components/MoveModal';
import { ShareModal } from '@/modules/file/pages/FolderContentsPage/components/ShareModal';
import { DeleteModal } from '@/modules/file/pages/FolderContentsPage/components/DeleteModal';

// Hooks
import { useFolderContents } from '@/modules/file/pages/FolderContentsPage/hooks/useFolderContents';
import { useFileOperations } from '@/modules/file/pages/FolderContentsPage/hooks/useFileOperations';
