// src/pages/file/CompanyDocuments/components/Toolbar.tsx

import React from 'react';
import { Search, Grid, List, ChevronDown } from 'lucide-react';
import type { ViewMode, SortBy, SortOrder } from '@/modules/file/types/CompanyDocuments/index';
        ...
        <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2">
                <select
                    ...
                    className="px-3 py-2 border border-gray-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 text-gray-700 dark:text-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
