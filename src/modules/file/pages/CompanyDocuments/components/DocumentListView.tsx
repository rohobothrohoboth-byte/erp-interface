...
import { getFileIcon, getDisplayName, getDisplaySize, getContentType, getUpdatedAt, getId, getOwner, getCategory, getDescription, getIsFavorite } from '@/modules/file/utils/CompanyDocuments/helpers';
