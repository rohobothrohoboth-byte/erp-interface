...
import { FolderCategorySection } from '@/modules/file/components/folders/FolderCategorySection';
import AddFolderModal from '@/modules/file/components/folders/AddFolderModal';
import type { FolderItem, FolderCategory } from '@/modules/file/types/folder.types';
import { MOCK_FOLDERS } from '@/modules/file/data/fileMockData';
