...
import { onboardingAssignmentApi } from './onboardingAssignment.api';
import { onboardingAssignmentKeys } from './onboardingAssignment.key';
import type {
    OnboardingAssignmentListDto,
    OnboardingAssignmentAddDto,
    OnboardingAssignmentModDto
} from '../../../../types/hr/recruit/onboardingAssignment';
