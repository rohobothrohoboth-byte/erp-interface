...
import type { FolderItem, DocumentItem, SortField, SortDir, ViewMode } from '../../../types/file/folder.types';
import { CATEGORY_PERMISSIONS, effectivePerms } from '../../../types/file/folder.types';
...
const DocViewerModal = lazy(() =>
  import('../../hr/employee/EmployeeDetail/DocViewerModal').then(m => ({ default: m.DocViewerModal }))
);
