...
interface EmailCampaignsSearchFilterProps {
  searchTerm: string;
  onSearchChange: (value: string) => void;
  onAddClick: () => void;
}

export default function EmailCampaignsSearchFilter({ searchTerm, onSearchChange, onAddClick }: EmailCampaignsSearchFilterProps) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
