...
const makeDefault = (workforcePlanId: string): JobReqAddDto => ({
  reqNumber: '', reqReason: '', reqPositions: 1, budgetCode: '',
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <Input required value={form.title}
                      ...
                      placeholder="e.g. Senior Software Engineer" disabled={isLoading} />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <EnumSelect enumObject={Gender} value={form.preGender as string}
                      onChange={(v) => setForm(f => ({ ...f, preGender: v as any }))}
                      placeholder="Select gender" disabled={isLoading} />
                  </div>
                  <div className="space-y-2">
                    <Label>Contract Type</Label>
                    <EnumSelect enumObject={EmpNature} value={form.contractType as string}
                      onChange={(v) => setForm(f => ({ ...f, contractType: v as any }))}
