...
const makeDefault = (workforcePlanId: string): JobReqAddDto => ({
  ...
  workLocation: '', preGender: '0' as any, contractType: '0' as any,
});
...
const AddJobRequisitionModal: React.FC<AddJobRequisitionModalProps> = ({
  ...
  const reset = () => { setForm(makeDefault(workforcePlanId)); setStep(1); };
            ...
            <div className="flex items-center gap-3 border-b px-6 py-4 sticky top-0 bg-white z-10">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Step {step} of 2 —{" "}
                  {step === 1 ? "Requisition Info" : "Job Description"}
                </p>
              </div>
              <div className="flex items-center gap-2">
                {[1, 2].map((s) => (
                  <div
                    key={s}
                    className={`h-2 w-8 rounded-full transition-colors ${s <= step ? "bg-green-500" : "bg-gray-200"}`}
                  />
                ))}
              </div>
            </div>
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min={1}
                      required
                      value={form.reqPositions}
                      onChange={(e) =>
                        setForm((f) => ({
                          ...f,
                          reqPositions: parseInt(e.target.value) || 1,
                        }))
                      }
                      disabled={isLoading}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setForm((f) => ({ ...f, budgetCode: e.target.value }))
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => {
                        setJobGradeId(v);
                        setForm((f) => ({ ...f, jgStepId: "" })); // reset step
                      }}
                      disabled={isLoading}
                    >
                      <SelectTrigger className="w-full">
                  ...
                  <div className="space-y-2">
                    <Label>
                      Job Grade Step <span className="text-red-500">*</span>
                    </Label>
                    <Select
                      value={form.jgStepId}
                      onValueChange={(v) =>
                        setForm((f) => ({ ...f, jgStepId: v }))
                      }
                      disabled={!jobGradeId || isLoading}
                    >
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Select grade step" />
                      </SelectTrigger>
                      <SelectContent>
                        {steps.map((o) => (
                          <SelectItem key={o.id} value={o.id}>
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setForm((f) => ({ ...f, reqReason: e.target.value }))
                      }
              ...
              {step === 2 && (
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <EnumSelect
                      enumObject={Gender}
                      value={form.preGender as string}
                      onChange={(v) =>
                        setForm((f) => ({ ...f, preGender: v as any }))
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <EnumSelect
                      enumObject={EmpNature}
                      value={form.contractType as string}
                      onChange={(v) =>
                        setForm((f) => ({ ...f, contractType: v as any }))
                      }
