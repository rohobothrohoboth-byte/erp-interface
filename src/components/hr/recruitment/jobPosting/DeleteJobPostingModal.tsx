...
const DeleteJobPostingModal: React.FC<DeleteJobPostingModalProps> = ({ isOpen, postNumber, isLoading = false, onClose, onConfirm }) => (
  <AnimatePresence>
    {isOpen && (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }}
          ...
          <div className="p-6 text-center">
            ...
            <p className="text-lg font-medium text-gray-900 mb-1">Delete Job Posting</p>
            <p className="text-sm text-gray-500 mb-1">
              Are you sure you want to delete <span className="font-semibold text-gray-700">"{postNumber}"</span>?
            </p>
