...
import { useWorkforcePlan, useDeleteWorkforcePlan, useSubmitWorkforcePlan, useApproveWorkforcePlan, useRejectWorkforcePlan } from '../../../../services/hr/recruitment/workforcePlan/workforcePlan.queries';
