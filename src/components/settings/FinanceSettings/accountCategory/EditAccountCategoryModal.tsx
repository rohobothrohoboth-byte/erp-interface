...
import type { AccountCategory } from "./AccountCategorySection";

interface EditAccountCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const EditAccountCategoryModal: React.FC<EditAccountCategoryModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  category
...
export default EditAccountCategoryModal;
