            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, accountCategoryId: value as UUID }))}
                  disabled={isLoading}
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, currencyId: value as UUID }))}
                  disabled={isLoading}
                >
                  <SelectTrigger className="w-full">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, companyId: value as UUID }))}
                  disabled={isLoading}
                >
                  <SelectTrigger className="w-full">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFormData(prev => ({ 
                      ...prev, 
                      accountType: value as 'Asset' | 'Liability' | 'Capital' | 'Income' | 'Expenditure'
                    }))}
                    disabled={isLoading}
                  >
                    <SelectTrigger className="w-full">
