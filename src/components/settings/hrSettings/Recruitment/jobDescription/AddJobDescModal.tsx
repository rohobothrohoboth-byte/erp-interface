...
import type { JobDescriptionAddDto } from '../../../../../types/hr/jobDescription';

interface AddJobDescModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: JobDescriptionAddDto) => void;
}

const defaultForm: JobDescriptionAddDto = {
  title: '',
  department: '',
  responsibilities: '',
  requirements: '',
...
const AddJobDescModal: React.FC<AddJobDescModalProps> = ({ isOpen, onClose, onSubmit }) => {
  const [form, setForm] = useState<JobDescriptionAddDto>(defaultForm);
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 border-b px-6 py-4 sticky top-0 bg-white z-10">
              ...
              <h2 className="text-lg font-bold text-gray-800">Add Job Description</h2>
            </div>
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="add-resp" className="text-sm font-medium text-gray-700">
                  ...
                  <div className="space-y-4">
                          <div className="space-y-2">
                      <Label htmlFor="add-dept" className="text-sm font-medium text-gray-700">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="add-req" className="text-sm font-medium text-gray-700">
...
export default AddJobDescModal;
