...
const EditOnboardingTaskModal: React.FC<EditOnboardingTaskModalProps> = ({ isOpen, item, onClose, onSubmit }) => {
  const [form, setForm] = useState<OnboardingTaskAddDto>({ taskName: '', description: '', sequenceOrder: 1 });

  useEffect(() => {
    if (item) setForm({ taskName: item.taskName, description: item.description, sequenceOrder: item.sequenceOrder });
  }, [item]);
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="edit-seqOrder" className="text-sm font-medium text-gray-700">
