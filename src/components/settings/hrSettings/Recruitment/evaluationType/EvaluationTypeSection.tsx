...
} from '../../../../../services/hr/recruitment/evaluationType/evaluationType.queries';
import type { 
  EvaluationTypeListDto, 
  EvaluationTypeAddDto 
} from '../../../../../types/hr/recruit/evaluationType';
import { evaluationTypeKeys } from '../../../../../services/hr/recruitment/evaluationType/evaluationType.key';
