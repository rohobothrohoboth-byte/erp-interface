            ...
            {paginated.length === 0 && (
              <tr>
                <td colSpan={5} className="px-6 py-12 text-center">
                  ...
                  <p className="text-sm font-medium text-gray-900 mb-1">No Evaluation Types Found</p>
                  <p className="text-sm text-gray-500">
                    {items.length === 0
                      ? 'Get started by creating your first evaluation type.'
                      : 'No evaluation types match your search.'}
                  </p>
                </td>
              </tr>
            )}
      ...
      {items.length > 0 && (
        <div className="bg-white px-6 py-3 flex items-center justify-between border-t border-gray-200">
          <p className="text-sm text-gray-700">
            ...
            <span className="font-medium">{items.length}</span> types
          </p>
