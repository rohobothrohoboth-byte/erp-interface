...
interface EvaluationTypeSearchFilterProps {
  searchTerm: string;
  setSearchTerm: (term: string) => void;
  onAddClick: () => void;
}

const EvaluationTypeSearchFilter: React.FC<EvaluationTypeSearchFilterProps> = ({
  searchTerm,
  setSearchTerm,
  onAddClick,
}) => {
...
export default EvaluationTypeSearchFilter;
