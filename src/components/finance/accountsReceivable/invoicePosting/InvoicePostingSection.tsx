...
import InvoicePostingHeader from './InvoicePostingHeader';
import InvoicePostingSearchFilter from './InvoicePostingSearchFilter';
import InvoicePostingTable from './InvoicePostingTable';
import type { SalesInvoice, JournalEntry } from '../types';
