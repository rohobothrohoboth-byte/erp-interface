...
interface EditBudgetPlanModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function EditBudgetPlanModal({
  ...
  if (!isOpen || !budgetPlan) return null;
      ...
      >
        <div className="flex justify-between items-center border-b px-6 py-2 sticky top-0 bg-white z-10">
          <div className="flex items-center gap-2">
            <FileText size={20} />
            <h2 className="text-lg font-bold text-gray-800">Edit Budget Plan</h2>
          </div>
          <button
            onClick={onClose}
