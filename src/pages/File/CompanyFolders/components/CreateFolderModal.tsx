// src/pages/file/CompanyFolders/components/CreateFolderModal.tsx

import React, { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { X, FolderPlus, Loader2 } from 'lucide-react';
import { FOLDER_TYPES } from '../../../../constants/file/CompanyFolders/categories';
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Create Company Folder</h2>
                            </div>
                            <button
                                onClick={handleClose}
