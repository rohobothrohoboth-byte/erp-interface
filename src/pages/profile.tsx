...
import { profileKeys } from "../services/profile/profile.keys";
...
const OverviewTab = lazy(() =>
    import("../components/profile/OverviewTab").then((m) => ({
        default: m.OverviewTab,
    })),
);
const BasicInfoTab = lazy(() =>
    import("../components/profile/BasicInfoTab").then((m) => ({
        default: m.BasicInfoTab,
    })),
);
const BiographicalTab = lazy(() =>
    import("../components/profile/BiographicalTab").then((m) => ({
        default: m.BiographicalTab,
    })),
);
const EmergencyTab = lazy(() =>
    import("../components/profile/EmergencyTab").then((m) => ({
        default: m.EmergencyTab,
    })),
);
const FamilyTab = lazy(() =>
    import("../components/profile/FamilyTab").then((m) => ({
        default: m.FamilyTab,
    })),
);
const GuarantorTab = lazy(() =>
    import("../components/profile/GuarantorTab").then((m) => ({
        default: m.GuarantorTab,
    })),
);
const EduExpTab = lazy(() => import("../components/profile/EduExpTab"));
